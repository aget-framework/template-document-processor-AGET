...
**Note**: This template was originally derived from `template-worker-aget` v2.7.0 with specialized document processing capabilities. Template version (v2.8.0) tracks template-specific features independently from the AGET framework version, which is currently v3.33.0.
...
- **AGET Framework** (v3.33.0): Framework compliance version

**Template v2.8.0** tracks format preservation capabilities added to this specialized template.
**AGET v3.33.0** indicates compliance with AGET framework standards and the base worker template.
