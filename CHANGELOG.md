...
### Fixed
- Added substantive Skill Routing and Write Scope guidance required by the Tier-1 template contract.
- Advanced framework identity, migration history, canonical references, and README surfaces to v3.33.1.
...
### Related Learnings
- Based on L245_ooxml_round_trip_verification.md (originated in a private upstream agent; promoted to canonical reference)
